...
if [[ $VER == "22.04" ]]; then
  CHAINWEB_FILE="chainweb-2.19.1.ghc-8.10.7.ubuntu-22.04.f9e4929.tar.gz"
elif [[ $VER == "20.04" ]]; then
  CHAINWEB_FILE="chainweb-2.19.1.ghc-8.10.7.ubuntu-20.04.f9e4929.tar.gz"
else
  decho "Are you using Ubuntu 20.04 or 22.04?"
  exit 1
fi

NODE=https://github.com/kadena-io/chainweb-node/releases/download/2.19.1/$CHAINWEB_FILE
