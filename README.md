...
rm chainweb-node
wget https://github.com/kadena-io/chainweb-node/releases/download/2.19.1/chainweb-2.19.1.ghc-8.10.7.ubuntu-22.04.f9e4929.tar.gz
tar -xvf chainweb-2.19.1.ghc-8.10.7.ubuntu-22.04.f9e4929.tar.gz
