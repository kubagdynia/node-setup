...
rm chainweb-node
wget https://github.com/kadena-io/chainweb-node/releases/download/2.20/chainweb-2.20.ghc-9.6.2.ubuntu-22.04.5615db5.tar.gz
tar -xvf chainweb-2.20.ghc-9.6.2.ubuntu-22.04.5615db5.tar.gz
